          ...
          {transactions.map((trx) => (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-2 py-2">
                ...
                <span className="inline-flex shrink-0 items-center gap-1 rounded-full bg-primary/15 px-2.5 py-0.5 text-[10px] font-bold text-primary-soft ring-1 ring-primary/30 shadow-sm mt-0.5">
